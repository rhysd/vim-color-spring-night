...
call s:hi('Special',      s:fg,       s:bg2,     0)
...
call s:hi('Todo',         s:bg,       s:error,   'bold')
call s:hi('Type',         s:type,     0,         0)
call s:hi('Underlined',   s:type,     0,         'underline')
...
call s:hi('SpellBad',     0,          s:error,   0)
call s:hi('SpellCap',     0,          s:bg4,     0)
call s:hi('SpellLocal',   0,          s:bg2,     0)
call s:hi('SpellRare',    0,          s:bg5,     0)
