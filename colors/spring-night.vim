...
call s:hi('DirvishArg',               s:yellow,     0,            'bold')
...
call s:hi('rstEmphasis',              0,         s:bgemphasis, 'italic')
call s:hi('rstStrongEmphasis',        0,         s:bgstrong,   'bold')
...
call s:hi('wastListDelimiter',        s:fg,      0,            0)
call s:hi('wastInstGeneral',          s:yellow,  0,            0)
call s:hi('wastInstWithType',         s:yellow,  0,            0)
call s:hi('wastUnnamedVar'  ,         s:purple,  0,            0)
