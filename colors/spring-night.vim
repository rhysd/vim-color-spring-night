...
call s:hi('Float',        s:lightgreen, 0,            0)
...
call s:hi('Number',       s:lightgreen, 0,            0)
...
call s:hi('Statement',    s:orange,     0,            0)
